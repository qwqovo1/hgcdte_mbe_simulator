...
.entry-card {
  width: 100%; height: 120px; background: #11111d; border: 1px solid #2d2d44;
  border-radius: 12px; display: flex; align-items: center; padding: 0 30px;
...
.card-icon { font-size: 40px; margin-right: 25px; }
.card-info h3 { font-size: 18px; margin-bottom: 5px; }
.card-info p { color: #6a6a85; font-size: 13px; }
.card-status { position: absolute; right: 20px; top: 15px; font-size: 11px; color: #00ff88; background: rgba(0,255,136,0.1); padding: 2px 8px; border-radius: 4px; }
...
.sidebar-section h4 { color: #00c7ff; font-size: 16px; margin-bottom: 12px; border-left: 3px solid #00c7ff; padding-left: 10px; }
.sidebar-section p { color: #8888a0; font-size: 13px; line-height: 1.6; }
.sidebar-section ul { padding-left: 15px; }
